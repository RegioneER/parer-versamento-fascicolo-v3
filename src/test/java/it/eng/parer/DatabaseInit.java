...
public class DatabaseInit {
    ...
    private int exceInsertScript(String filename) {
        try {
            final String sql = IOUtils.toString(this.getClass().getResourceAsStream(SCRIPT_PATH + filename),
    ...
    public void insertParametroAATipoFascicolo(String parametro, String valore, long idAATipoFascicolo) {
        try {
            AplParamApplic aplParamApplic = new AplParamApplic();
