...
class TransactionRollbackTest {
    ...
    void savingThrowsRuntimeException_shouldRollback() {
        ...
        try {
            ...
            Assertions.assertNull(findAplValoreParamApplic(aplValoreParamApplic.getIdValoreParamApplic()));
        }
    }
    ...
    void savingThrowsCustomException_shouldSave() {
        ...
        try {
            ...
            Assertions.assertNotNull(findAplValoreParamApplic(aplValoreParamApplic.getIdValoreParamApplic()));
            delete(aplParamApplic.getIdParamApplic(), aplValoreParamApplic.getIdValoreParamApplic());
        }
    }

    /**
     * @Transactional(rollbackOn = TransactionTestingException.class) => se viene sollevata l'eccezione
     *                           TransactionTestingException va in rollback
     */
    @Test
    ...
    /**
     * @Transactional(rollbackOn = TransactionTestingException.class) => se viene sollevata una eccezione diversa da
     *                           TransactionTestingException che NON estende RuntimeException non fa nulla
     */
    @Test
    ...
    /**
     * @Transactional(rollbackOn = TransactionTestingException.class) => se viene sollevata una T extend
     *                           RuntimeException, anche se diversa da quella indicata dal rollbackOn, fa comunque
     *                           rollback
     */
    @Test
    ...
    void savingThrowsExceptionDontRollbackOn_shouldSave() {
        ...
        final AplValoreParamApplic aplValoreParamApplic = createAplValoreParamApplic();
        try {
            service.saveThrowsRuntimeExceptionsWithDontRollbackOn(aplParamApplic, aplValoreParamApplic,
                    new TransactionRuntimeTestingException());
        } catch (Exception e) {
            Assertions.assertNotNull(findAplParamApplic(aplParamApplic.getIdParamApplic()));
            Assertions.assertNotNull(findAplValoreParamApplic(aplValoreParamApplic.getIdValoreParamApplic()));
    ...
    /**
     * @Transactional(dontRollbackOn = TransactionTestingException.class) => se viene sollevata un'eccezione diversa da
     *                               TransactionTestingException fa rollback
     */
    @Test
    ...
    void savingHandledException_shouldSave() {
        final AplParamApplic aplParamApplic = createAplParamApplic();
        final AplValoreParamApplic aplValoreParamApplic = createAplValoreParamApplic();
        service.saveHandleExceptions(aplParamApplic, aplValoreParamApplic, new TransactionRuntimeTestingException());
        Assertions.assertNotNull(findAplParamApplic(aplParamApplic.getIdParamApplic()));
        Assertions.assertNotNull(findAplValoreParamApplic(aplValoreParamApplic.getIdValoreParamApplic()));
        delete(aplParamApplic.getIdParamApplic(), aplValoreParamApplic.getIdValoreParamApplic());
    }
    ...
    /**
     * @Transactional(rollbackOn = TransactionTestingException.class) => quando l'eccezione è gestita in un try-catch
     *                           non entrano in gioco i rollback
     */
    @Test
    ...
    /**
     * @Transactional(dontRollbackOn = TransactionTestingException.class) => quando l'eccezione è gestita in un
     *                               try-catch non entrano in gioco i rollback
     */
    @Test
