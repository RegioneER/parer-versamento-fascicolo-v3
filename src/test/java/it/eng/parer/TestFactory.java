...
public class TestFactory {
    ...
    public class VersFascicoloExtBuilder {
        ...
        public VersFascicoloExtBuilder addDatiXmlProfiloGenerale() {
            getVersamento().getStrutturaComponenti().setDatiXmlProfiloGenerale(new DatiXmlProfiloGenerale());
            getVersamento().getStrutturaComponenti().getDatiXmlProfiloGenerale()
                    .setProcAmm(new DXPGProcAmmininistrativo());
            getVersamento().getStrutturaComponenti().getDatiXmlProfiloGenerale().setEventi(new ArrayList<>());
            getVersamento().getStrutturaComponenti().getDatiXmlProfiloGenerale().setSoggetti(new ArrayList<>());
            return this;
        }

        public VersFascicoloExtBuilder addDatiXmlProfiloArchivistico() {
            getVersamento().getStrutturaComponenti().setDatiXmlProfiloArchivistico(new DatiXmlProfiloArchivistico());
            return this;
        }

        public VersFascicoloExtBuilder addDatiXmlProfiloNormativo() {
            getVersamento().getStrutturaComponenti().setDatiXmlProfiloNormativo(new DatiXmlProfiloNormativo());
            getVersamento().getStrutturaComponenti().getDatiXmlProfiloNormativo().setSoggetti(new ArrayList<>());
            return this;
        }
