...
class LogSessioneFascicoliServiceRollbackTest {
    ...
    void mockAll() throws AppGenericPersistenceException, ObjectStorageException {
        ...
        when(logSessioneFascicoliDao.scriviFascicoloErr(any(), any(), any()))
                .then(args -> writeMockDataThenReturnRipostaControlliTrue(new VrsSesFascicoloErr()));
    ...
    @Test
    void registraSessioneErrata_scriviFascicoloErrFails_rollback() throws AppGenericPersistenceException {
        RispostaWSFascicolo rispostaWs = rispostaWs();

        // dato che il mock di scriviFascicoloErr viene definito come transazionale (usa entityManager) nella
    ...
    private AppGenericPersistenceException assertTrhowsAppGenericPersistenceException(Executable executable) {
    ...
    @Test
    void registraSessioneErrata_scriviXmlFascicoloErrFails_rollback() throws AppGenericPersistenceException {
        RispostaWSFascicolo rispostaWs = rispostaWs();
        doThrow(AppGenericPersistenceException.class).when(logSessioneFascicoliDao).scriviXmlFascicoloErr(any(), any(),
                any(), any(), any());
        final AppGenericPersistenceException appException = assertTrhowsAppGenericPersistenceException(
                () -> logSessioneFascicoliService.registraSessioneErrata(rispostaWs, new VersFascicoloExt(),
                        new BlockingFakeSession()));
    ...
    @Test
    void registraSessioneFallita_scriviSessioneFascicoloKo_rollback() throws AppGenericPersistenceException {
        // dato che il mock di scriviSessioneFascicoloKo viene definito come transazionale (usa entityManager) nella
        // mockAllRispostaControlliTrue
        // è necessario resettarlo per fargli ritornare un semplice oggetto RispostaControlli
        reset(logSessioneFascicoliDao);
        when(logSessioneFascicoliDao.scriviSessioneFascicoloKo(any(), any(), any(), any(), any()))
    ...
    @Test
    void registraSessioneFallita_cercaFascicoloKoFails_rollback() throws AppGenericPersistenceException {
        RispostaWSFascicolo rispostaWs = rispostaWs();

        doThrow(appGenericPersistenceException()).when(logSessioneFascicoliDao).cercaFascicoloKo(any());
    ...
    @Test
    void registraSessioneFallita_scriviFascicoloKoFails_rollback() throws AppGenericPersistenceException {
        RispostaWSFascicolo rispostaWs = rispostaWs();

        doThrow(appGenericPersistenceException()).when(logSessioneFascicoliDao).scriviFascicoloKo(any(), any(), any());
    ...
    @Test
    void registraSessioneFallita_scriviXmlFascicoloKoFails_rollback() throws AppGenericPersistenceException {
        RispostaWSFascicolo rispostaWs = rispostaWs();

        doThrow(appGenericPersistenceException()).when(logSessioneFascicoliDao).scriviXmlFascicoloKo(any(), any(),
                any(), any(), any(), any());
        final AppGenericPersistenceException appException = assertTrhowsAppGenericPersistenceException(
                () -> logSessioneFascicoliService.registraSessioneFallita(rispostaWs, new VersFascicoloExt(),
                        new BlockingFakeSession()));
    ...
    @Test
    void registraSessioneFallita_scriviErroriFascicoloKoFails_rollback() throws AppGenericPersistenceException {
        RispostaWSFascicolo rispostaWs = rispostaWs();

        doThrow(appGenericPersistenceException()).when(logSessioneFascicoliDao).scriviErroriFascicoloKo(any(), any());
    ...
    public List<AplParamApplic> listAllMockData() {
        return em.createQuery("SELECT v FROM AplParamApplic v", AplParamApplic.class).getResultList();
    }
    ...
    private RispostaWSFascicolo rispostaWs() {
        ...
        rispostaWSFascicolo.getCompRapportoVersFascicolo().setEsitoGenerale(new EsitoGeneraleType());
