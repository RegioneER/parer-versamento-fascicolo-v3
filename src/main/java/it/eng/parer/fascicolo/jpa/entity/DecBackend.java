...
public class DecBackend implements Serializable {
    ...
    public void setXmlVersFascObjectStorages(List<FasXmlVersFascObjectStorage> xmlVersFascObjectStorages) {
    ...
    public void setXmlSesFascKoObjectStorages(List<VrsXmlSesFascKoObjectStorage> xmlSesFascKoObjectStorages) {
    ...
    public void setXmlSesFascErrObjectStorages(List<VrsXmlSesFascErrObjectStorage> xmlSesFascErrObjectStorages) {
