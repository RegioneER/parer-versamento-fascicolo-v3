...
public class VersFascicoloParserService implements IVersFascicoloParserService {
    ...
    @Override
    public void parseXML(BlockingFakeSession sessione, VersFascicoloExt versamento, RispostaWSFascicolo rispostaWs) {
        //
        ...
        if (rispostaWs.getSeverity() == SeverityEnum.OK) {
            ...
            versamento.getStrutturaComponenti()
                    .setVersioneIndiceSipNonVerificata(parsedIndiceFasc.getParametri().getVersioneIndiceSIPFascicolo());
        ...
        if (rispostaWs.getSeverity() == SeverityEnum.OK) {
            if (parsedIndiceFasc.getParametri() != null) {
                ...
                mySip.setDataVersamento(XmlDateUtility.dateToXMLGregorianCalendarOrNull(sessione.getTmApertura()));
        ...
        // con quelli nell'xml
        if (rispostaWs.getSeverity() == SeverityEnum.OK) {
            this.controllaUserIdAndVersioneWS(myControlliFascicolo, versamento, rispostaWs, sessione);
        }
        ...
        // verifico la chiave
        if (rispostaWs.getSeverity() == SeverityEnum.OK) {
            this.controllaChiave(myControlliFascicolo, myEsito, versamento, rispostaWs, descChiaveFasc, tagCSChiave);
        }
        ...
        if (rispostaWs.getSeverity() == SeverityEnum.OK) {
            this.controllaTipoConservazione(myControlliFascicolo, rispostaWs, sessione, descChiaveFasc);
        }
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            prosegui = controllaUdFascAndProfiloGenerale(myEsito, myControlliFascicolo, versamento, sessione,
                    descChiaveFasc);
            ...
            if (prosegui) {
                ...
                this.controllaFormatoNumero(myEsito, versamento, sessione, sistema, descChiaveFasc, tagCSChiave);
                // check collegamenti
    ...
    private boolean controllaProfiloNormativo(CompRapportoVersFascicolo myEsito, VersFascicoloExt versamento,
        ...
        boolean isVerificaProfiloNormativoOk = controlliProfiliFascicoloService.verificaProfiloNormativo(versamento,
                sessione);
    ...
    private boolean controllaFlagStruttura(VersFascicoloExt versamento, RispostaWSFascicolo rispostaWs,
        ...
        if (rcCheckFlDecAaTipoFascicoloOrgStrutt.isrBoolean()) {
            FlControlliFasc flControlliFasc = (FlControlliFasc) rcCheckFlDecAaTipoFascicoloOrgStrutt.getrObject();
            ...
            ecconfigurazioneType.setForzaNumero(flControlliFasc.isFlForzaContrNumero());// set configurationDao di
            // struttura
            ...
            ecconfigurazioneType.setForzaCollegamento(flControlliFasc.isFlForzaContrColleg());// set configurationDao di
            // struttura
        ...
        return prosegui;// i controlli successivi, senza il flag, non possono continuare! (non dovrebbe
        // mai accadere!)
    }

    private void controllaClassificazione(CompRapportoVersFascicolo myEsito, VersFascicoloExt versamento,
            BlockingFakeSession sessione, String descChiaveFasc) {
        ...
        if (svf.getDatiXmlProfiloGenerale() != null && svf.getDatiXmlProfiloArchivistico() != null) {
            ...
            if (!flContrFasc.isFlAbilitaContrClassif()) {
                ...
                RispostaControlli rcVerificaSIPTitolario = controlliFascicoliService.verificaSIPTitolario(svf);
                ...
                if (!rcVerificaSIPTitolario.isrBoolean()) {
                    ...
                    if (!flContrFasc.isFlAccettaContrClassifNeg()) {
                        ...
                        if (flForzaClass) {
                            ...
                            versamento.addWarning(descChiaveFasc, rcVerificaSIPTitolario.getCodErr(),
                     ...
                     */
                    // set risultato
                    versamento.getStrutturaComponenti().setIdVoceTitol(rcVerificaSIPTitolario.getrLong());
    ...
    private void controllaFormatoNumero(CompRapportoVersFascicolo myEsito, VersFascicoloExt versamento,
            BlockingFakeSession sessione, String sistema, String descChiaveFasc, CSChiaveFasc tagCSChiave) {
        ECFascicoloType.EsitoControlliFascicolo myControlliFascicolo = myEsito.getFascicolo()
                .getEsitoControlliFascicolo();
        ...
        RispostaControlli rcPartiAANumero = controlliFascicoliService.getPartiAANumero(descChiaveFasc,
                svf.getIdAATipoFasc());

        // ritorna eventuali errori e prosegue con successivi controlli
        if (!rcPartiAANumero.isrBoolean()) {
            // aggiungo l'errore restituito alla lista errori
            versamento.addError(descChiaveFasc, rcPartiAANumero.getCodErr(), rcPartiAANumero.getDsErr());
            return;
        }
        ...
        RispostaControlli rcVerificaChiave = tmpKeyOrdFascUtility.verificaChiave(tagCSChiave, svf.getIdStruttura(),
        ...
        if (rcVerificaChiave.isrBoolean()) {
            ...
            RispostaControlli rcCalcolaKeyOrdGenerica = tmpKeyOrdFascUtility.calcolaKeyOrdGenerica(tagCSChiave);
            ...
            if (!rcPartiAANumero.isrBoolean()) {
                ...
                if (!flContrFasc.isFlAccettaContrNumeroNeg()) {
                    ...
                    if (flForzaContrNum) {
                        ...
                        // aggiungo l'errore restituito alla lista errori
                        versamento.addWarning(descChiaveFasc, rcPartiAANumero.getCodErr(), rcPartiAANumero.getDsErr());
    ...
    private void controllaCollegamenti(CompRapportoVersFascicolo myEsito, VersFascicoloExt versamento,
            BlockingFakeSession sessione) {
        ECFascicoloType.EsitoControlliFascicolo myControlliFascicolo = myEsito.getFascicolo()
                .getEsitoControlliFascicolo();
        ...
        if (svf.getDatiXmlProfiloArchivistico() != null
            ...
            List<FascicoloLink> fascicoliToBeLinked = (List<FascicoloLink>) rcBuildCollegamentiFascicolo.getrObject();
            ...
            if (!isFlAbilitaContrColleg && (!linkHasBuilt || rcBuildCollegamentiFascicolo.getCodErr() == null
                    || !rcBuildCollegamentiFascicolo.getCodErr()
                            .equals(MessaggiWSBundle.FASC_006_002)/* eseguo lo stesso il controllo */)) {
                myControlliFascicolo.setCodiceEsito(ECEsitoPosNegWarType.NON_ATTIVATO);
                ...
                if (linkHasBuilt) {
                    for (Iterator<FascicoloLink> it = svf.getFascicoliLinked().iterator(); it.hasNext();) {
                        ...
                        RispostaControlli rcCheckChiave = controlliFascicoliService.checkChiave(csChiaveFascColl,
                                "dummy", svf.getIdStruttura(), TipiGestioneFascAnnullati.CARICA);// indipendentemente
                        ...
                        if (rcCheckChiave.isrBoolean()) {
                            ...
                            toBeLinked.setIdLinkFasc(rcCheckChiave.getrLong());// fk fascicolo trovato
                        }

                        // verifica descrizione
                        if (toBeLinked.getDescCollegamento().length() > Costanti.COLLEGAMENTO_DESC_MAX_SIZE) {
    ...
    private void controllaUserIdAndVersioneWS(ECFascicoloType.EsitoControlliFascicolo myControlliFascicolo,
            VersFascicoloExt versamento, RispostaWSFascicolo rispostaWs, BlockingFakeSession sessione) {
        IndiceSIPFascicolo parsedIndiceFasc = sessione.getIndiceSIPFascicolo();
    ...
    private void controllaStruttura(ECFascicoloType.EsitoControlliFascicolo myControlliFascicolo,
        ...
        if (rcCheckIdStrut.getrLong() < 1) {
            ...
            if (rcCheckIdStrut.getrLongExtended() < 1) {
                ...
                versamento.getStrutturaComponenti().setIdStruttura(rcCheckIdStrut.getrLongExtended());
                // salvo idUtente
    ...
    private void controllaTipoFasc(ECFascicoloType.EsitoControlliFascicolo myControlliFascicolo,
        ...
        if (!rcCheckTipoFascicolo.isrBoolean()) {
            ...
            rispostaWs.setSeverity(SeverityEnum.ERROR);
            rispostaWs.setEsitoWsError(rcCheckTipoFascicolo.getCodErr(), rcCheckTipoFascicolo.getDsErr());
    ...
    private void controllaTipoFascUserOrg(EsitoControlliFascicolo myControlliFascicolo, VersFascicoloExt versamento,
        ...
        RispostaControlli rcCheckTipoFascicoloIamUserOrganizzazione = controlliFascicoliService
                .checkTipoFascicoloIamUserOrganizzazione(descChiaveFasc, svf.getTipoFascicoloNonverificato(),
                        svf.getIdStruttura(), svf.getIdUser(), svf.getIdTipoFascicolo());
    ...
    private void controllaTipoFascAnno(EsitoControlliFascicolo myControlliFascicolo, VersFascicoloExt versamento,
        ...
        //
        StrutturaVersFascicolo svf = versamento.getStrutturaComponenti();
        RispostaControlli rcCheckTipoFascicoloAnno = controlliFascicoliService.checkTipoFascicoloAnno(descChiaveFasc,
        ...
        if (!rcCheckTipoFascicoloAnno.isrBoolean()) {
            ...
            myControlliFascicolo.setVerificaTipoFascicolo(ECEsitoPosNegType.NEGATIVO);
            rispostaWs.setSeverity(SeverityEnum.ERROR);
            rispostaWs.setEsitoWsError(rcCheckTipoFascicoloAnno.getCodErr(), rcCheckTipoFascicoloAnno.getDsErr());
            // se non è verificato posso sempre
            // tentare di riscostruire la chiave ed il tipo fascicolo
            // e trasformare la sessione errata in una sessione fallita
            rispostaWs.setStatoSessioneVersamento(IRispostaWS.StatiSessioneVersEnum.DUBBIA);
            ...
            versamento.getStrutturaComponenti().setIdAATipoFasc(rcCheckTipoFascicoloAnno.getrLong());
            // OK - popolo la risposta versamento
            myControlliFascicolo.setVerificaTipoFascicolo(ECEsitoPosNegType.POSITIVO);
        }
    ...
    private void controllaChiave(ECFascicoloType.EsitoControlliFascicolo myControlliFascicolo,
        ...
        RispostaControlli rcCheckChiave = controlliFascicoliService.checkChiave(tagCSChiave, descChiaveFasc,
                versamento.getStrutturaComponenti().getIdStruttura(), TipiGestioneFascAnnullati.CONSIDERA_ASSENTE);
        if (!rcCheckChiave.isrBoolean()) {
            myControlliFascicolo.setCodiceEsito(ECEsitoPosNegWarType.NEGATIVO);
    ...
    private void calcAndCrontrolCdKeyNorm(VersFascicoloExt versamento, RispostaWSFascicolo rispostaWs,
            CSChiaveFasc tagCSChiave) {
        ...
        RispostaControlli rispostaControlli = controlliFascicoliService.calcAndcheckCdKeyNormalized(tagCSChiave,
                versamento.getStrutturaComponenti().getIdStruttura(), cdKeyNormalized);
        if (!rispostaControlli.isrBoolean()) {
            ...
            // normalized cd_key
            versamento.getStrutturaComponenti().setCdKeyFascicoloNormalized(rispostaControlli.getrString());
        }
    }
    ...
    private boolean controllaUdFascAndProfiloGenerale(CompRapportoVersFascicolo myEsito,
        ...
        boolean isVerificaUdFascicoloOk = controlliCollFascicoloService.verificaUdFascicolo(versamento,
                myEsito.getFascicolo(), sessione);
        if (!isVerificaUdFascicoloOk) {
            myControlliFascicolo.setCodiceEsito(ECEsitoPosNegWarType.NEGATIVO);
            myControlliFascicolo.setControlloConsistenzaUnitaDocumentarie(ECEsitoPosNegType.NEGATIVO);
            // la lista errori è già stata popolata dal metodo, non faccio nulla
            prosegui = false;
        } else {
            myControlliFascicolo.setControlloConsistenzaUnitaDocumentarie(ECEsitoPosNegType.POSITIVO);
        }
        ...
        if (prosegui) {
            ...
            boolean isVerificaProfiloGeneraleOk = controlliProfiliFascicoloService.verificaProfiloGenerale(versamento,
                    myEsito.getFascicolo(), sessione);
    ...
    private boolean controllaProfiloSpecifico(CompRapportoVersFascicolo myEsito, VersFascicoloExt versamento,
        ...
        ECFascicoloType.EsitoControlliFascicolo myControlliFascicolo = myEsito.getFascicolo()
                .getEsitoControlliFascicolo();
        // Controllo profilo Archivistico
        boolean isVerificaProfiloSpecificoOk = controlliProfiliFascicoloService.verificaProfiloSpecifico(versamento,
                syncFakeSession);
    ...
    private void controllaSoggettoProd(CompRapportoVersFascicolo myEsito, VersFascicoloExt versamento,
            BlockingFakeSession sessione, String descChiaveFasc) {
        ECFascicoloType.EsitoControlliFascicolo myControlliFascicolo = myEsito.getFascicolo()
                .getEsitoControlliFascicolo();
        IndiceSIPFascicolo parsedIndiceFasc = sessione.getIndiceSIPFascicolo();
