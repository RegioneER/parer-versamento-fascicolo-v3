...
public class AvanzamentoWs implements java.io.Serializable {
    ...
    public enum CheckPoints {
        ...
        INIZIO, VERIFICA_STRUTTURA_CHIAMATA_WS, VERIFICA_XML, VERIFICA_SEMANTICA, SALVATAGGIO_DATI_VERSATI,
        SALVATAGGIO_SESSIONE_WS, CREAZIONE_RISPOSTA, TRASFERIMENTO_PAYLOAD_IN, LETTURA_IP_VERSANTE, INVIO_RISPOSTA, FINE
    }
