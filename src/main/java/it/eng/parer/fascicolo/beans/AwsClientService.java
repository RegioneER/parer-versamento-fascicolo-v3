 ...
 *
 * @author Snidero_L, DiLorenzo_F
 */
@Singleton
public class AwsClientService {

    private final Logger log = LoggerFactory.getLogger(AwsClientService.class);
    ...
    /**
     * Ottieni il client configurato con Quarkus per il collegamento a questo OS
     *
     *
