...
public class ProfileArchDataPrsr {
    ...
    public static DatiXmlProfiloArchivistico recuperaDatiDaXmlPA(ProfiloArchivisticoType pat) {
        ...
        try {
            ...
            XPathExpression expr = xpath
                    .compile("//" + selector + "/Classificazione" + "/IndiceClassificazione/text()");
            ...
            expr = xpath.compile("//" + selector + "/Classificazione" + "/DescrizioneIndiceClassificazione"
                    + "/VoceClassificazione");
    ...
    private static void recuperaCollegamenti(DatiXmlProfiloArchivistico tmpDatiXml, Node tmpDati, XPath xpath)
    ...
    private static void recuperaPianoCons(DatiXmlProfiloArchivistico tmpDatiXml, Node tmpDati, XPath xpath)
            throws XPathExpressionException {
