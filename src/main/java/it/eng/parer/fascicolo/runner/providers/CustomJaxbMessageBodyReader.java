...
/*
 * Provider che estende JaxbMessageBodyReader per ampliarne la logica, aggiungendo : validazione con xsd,
 * gestione avanzata dell'encoding del body del messaggio (nell'XML in caso specificio).
 */
@Provider
